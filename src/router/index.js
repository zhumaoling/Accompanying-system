...
import AdminView from '../views/auth/admin/index.vue'
import GroupView from '../views/auth/group/index.vue'
import OrderView from '../views/vppz/order/index.vue'
import StaffView from '../views/vppz/staff/index.vue'
...
const routes = [
  {
    ...
    children: [
      ...
      // {
      //   path: 'vppz',
      //   meta: { id: '3', name: 'CARE陪诊', icon: 'BellFilled' },
      //   children: [
      //     {
      //       path: '',
      //       alias: ['staff'],
